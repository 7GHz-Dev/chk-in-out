...
- ประวัติพร้อม thumbnail แผนที่ของจุดเข้างานและเลิกงาน โหลดเมื่อเลื่อนใกล้ถึงรายการ (ใช้ภาพ Google Static Maps เมื่อตั้ง `GOOGLE_MAPS_API_KEY` ไม่งั้นถอยไปใช้แผนที่ฝัง OpenStreetMap)

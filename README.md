...
- ประวัติและรายงานใช้ตารางแบบเดียวกัน เข้างานกับเลิกงานอยู่แถวเดียวกัน พร้อมรูปถ่าย Plus Code ของ Google และ thumbnail แผนที่ ของตำแหน่งโดยประมาณ (แผนที่ฝังแบบไม่ต้องใช้ key และเปลี่ยนเป็นภาพนิ่ง Google Static Maps อัตโนมัติเมื่อตั้ง `GOOGLE_MAPS_API_KEY`)

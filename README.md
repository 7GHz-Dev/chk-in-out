...
- ดูประวัติพร้อมรูปและ thumbnail แผนที่ Google ของตำแหน่งโดยประมาณ (แผนที่ฝังแบบไม่ต้องใช้ key และเปลี่ยนเป็นภาพนิ่ง Google Static Maps อัตโนมัติเมื่อตั้ง `GOOGLE_MAPS_API_KEY`)
